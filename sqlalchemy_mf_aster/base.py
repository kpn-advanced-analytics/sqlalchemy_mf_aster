...
# Large piece of code is taken from https://github.com/KarolTx/sqlalchemy_aster
# Aster JDBC has a problem returning cursor when executing query on nc_system.nc_all_tables -> all model_factory tables are hard coded
# Problem is communicated to Aster
#
...
class AsterDialect(default.DefaultDialect):
    ...
    def initialize(self, connection):
        super(AsterDialect, self).initialize(connection)
    ...
    def has_table(self, connection, tablename, schema=None):
        ...
        #                sql.text(
        #                    "select count(*) from nc_system.nc_all_tables where "
        #                    "valid = true and tablename=:name"), name=tablename
        #                )
        #return bool(result)
        return True
